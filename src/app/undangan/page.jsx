    ...
    <main className={styles.container}>
      {loader ? (
        ...
        <div className={styles.wrapper}>
          ...
          <div className={styles.opening} id="location">
            <p>
              HARRIS Hotel & Conventions Kelapa Gading <br /> Jl. Boulevard Bar.
              Raya No.RT.13, RT.13/RW.18, Klp. Gading Tim., Kec. Klp. Gading,
